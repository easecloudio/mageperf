...
import { OptimizationRoadmap } from '@/components/report/OptimizationRoadmap';
import { useParams } from 'next/navigation';
import { useReport } from '@/contexts/ReportContext';

export default function OptimizationRoadmapPage() {
  ...
  return (
    <DualSidebarLayout reportId={taskId}>
      <OptimizationRoadmap reportData={reportData} />
    </DualSidebarLayout>
  );
}
